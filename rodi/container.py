...
from typing import Any, Callable, DefaultDict, Dict, Optional, Set, Type, TypeVar, Union

from rodi.common import (
    AliasesTypeHint,
    get_factory_annotations_or_throw,
    class_name,
...
from rodi.resolvers import ResolutionContext
from rodi.resolvers import (
    DynamicResolver,
    FactoryCallableType,
    FactoryResolver,
...
from .abc import ContainerProtocol
from .services import ServiceLifeStyle, Services
...
class Container(ContainerProtocol):
    """
    Configuration class for a collection of services. This class offers methods to
